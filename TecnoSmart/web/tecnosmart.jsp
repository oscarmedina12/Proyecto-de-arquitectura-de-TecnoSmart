...
<html>
  ...
  <div class="header-right">
    ...
    <a  href="Listar.jsp">Ver servicios</a>
      <a ><form action="Salir" method="POST">
        <div>
            <input class="btn" type="submit" name="accion" value="Cerrar Sesión">
        </div>
    </form></a>
  </div>
</div>
    ...
    <center>
        ...
        <%}%>
         ...
         <img src="imagen/servicio-tecnico-scooter.png" width="450" height="250">
